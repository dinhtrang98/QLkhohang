...
namespace QLKhoHang
{
    public partial class Phiếu_Xuất : Form
    {
        ...
        private void hien()
        {
            string sql = @"SELECT PhieuXuat.NgayXuat, PhieuXuat.NguoiXuat, PhieuXuat.MaKH
                                  , PhieuXuat.SoLuongXuat, PhieuXuat.MaHH, PhieuXuat.MaPXK
                                  , DMKhachHang.tenkh,DMHangHoa.tenhh
                            FROM 
                                DMHangHoa INNER JOIN
        ...
        private void btnthoat_Click(object sender, EventArgs e)
        {
            ...
            this.Close();
            new GiaoDienChinh().Visible = true;
        }
            ...
            if (validate())
            {
                ...
                if (state == "insert")
                {
                    ...
                    string sql = @"INSERT INTO [QLKhoHang].[dbo].[PhieuXuat]
                               ([NgayXuat],[NguoiXuat],[MaKH],[SoLuongXuat],[MaHH])
                         VALUES
